            ...
            get {
                if (settingsDirectory != null) {
                    ...
                    if (SystemInfo.IsRunningOnLinux ()) {
                        ...
                        directory = Environment.GetFolderPath (System.Environment.SpecialFolder.UserProfile) + "\\Shell\\";
                    }
            ...
            get {
                if (cacheDirectory != null) {
                    ...
                    if (SystemInfo.IsRunningOnLinux ()) {
                        ...
                        directory = Environment.GetFolderPath (System.Environment.SpecialFolder.UserProfile) + "\\ShellCache\\";
                    }
                    Directory.CreateDirectory (directory);
