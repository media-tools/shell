    ...
    public sealed class Tree : CommonShare<Tree>
    {
        ...
        public void CreateIndex ()
        {
            if (FileMap == null) {
                ...
                IEnumerable<FileInfo> files = FileSystemLibrary.GetFileList (rootDirectory: RootDirectory, fileFilter: excludeTreeConfig, dirFilter: dir => true, followSymlinks: false);
